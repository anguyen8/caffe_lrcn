...
def main():
  ...
  IMAGE_NET_FILE = '/home/anh/workspace/upconvnet/caffenet/encoder.prototxt'
  ...
  caption, probs = captioner.sample_caption(descriptor, strategy=strategy, max_length=20)

#  print ">>> output_captions", caption
  
  words_caption = captioner.sentence(caption)
  score = np.mean(probs)
  print ">>>> : [", words_caption, "] %.2f" % score
#  print words_caption
